...
{{
  ...
  "location": {{
    "@type": "Place",
    "name": "MN Saha Auditorium & G06, IISER Kolkata",
    "address": {{
      "@type": "PostalAddress",
  ...
  "offers": [
    {{
      "@type": "Offer",
      "name": "IISER Kolkata student registration",
      "description": "Free participation for IISER Kolkata students only.",
    ...
    {{
      ...
      "description": "Registration for external participants. Optional hostel accommodation costs INR 200 per day, separately from registration.",
      "availability": "https://schema.org/InStock",
      "url": "{BASE}/register.html",
      "priceCurrency": "INR",
      "price": 200
...
<header class="nav">
  <div class="nav__inner">
    ...
    <div class="nav__actions">
      ...
      <button class="nav__burger" type="button" aria-expanded="false" aria-controls="nav-menu" aria-label="Open navigation">
...
PARTNERS = [
    {
        "name": "IBM Quantum",
        "src": "assets/brand/ibm-quantum-light.webp",
        "href": "https://quantum.ibm.com",
        "h": 24,
    },
    {
        "name": "Qiskit",
        "src": "assets/brand/qiskit-logo-light.svg",
        "href": "https://qiskit.org",
        "h": 44,
    },
    {
        "name": "SlashDot",
        "src": "assets/brand/slashdot-light.webp",
    ...
    {
        "name": "IISER Kolkata",
        "src": "assets/brand/iiserk-emblem.svg",
        "inline": True,
...
def inline_svg(path: str, height: int, label: str) -> str:
    ...
    markup = markup.replace(
        "<svg ",
        f'<svg class="partner__mark" data-logomark style="--partner-h:{height}px" ',
        1,
    )
    markup = (
        markup.replace(' role="img"', f' role="img" aria-label="{label}"', 1)
        if "aria-label" not in markup
        else markup
    )
    return markup
...
def partners(size: str = "sm") -> str:
    ...
    for partner in PARTNERS:
        ...
        if partner.get("inline") and size == "sm":
            ...
            inner = (
                f'<img src="{partner["src"]}" alt="{partner["name"]}" '
                f'style="--partner-h:{height}px" '
                f'loading="lazy" decoding="async">'
            )
        else:
            inner = (
                f'<span class="partner__placeholder">{partner["name"]}'
                f"<small>logo to come</small></span>"
            )
        if partner["href"]:
            out.append(
                f'<a class="partner" href="{partner["href"]}" target="_blank" rel="noopener" '
                f'aria-label="{partner["name"]}">{inner}</a>'
            )
        else:
            out.append(
                f'<span class="partner" aria-label="{partner["name"]}">{inner}</span>'
            )
    return "".join(out)
...
def build() -> str:
    ...
    stickers = "".join(
        ...
        f'loading="lazy" decoding="async">'
        for name in STICKER_STRIP * 2
    )
    marquee = "".join(
        f'<span class="marquee__item"><b>{k}</b> {v}</span>'
        for k, v in MARQUEE_ITEMS * 2
    )
...
<main id="main">
  ...
  <section class="hero" data-hero>
    <div class="hero__inner">
      ...
      <div class="hero__cta" data-hero-in>
        <a class="btn btn--lg btn--machine" href="#schedule">
      ...
      <div class="hero__register" data-hero-in>
  ...
  <section class="section" id="about">
    <div class="container">
      ...
      <div class="figure-row" data-drop-group="90">
        ...
        <div class="figure" data-drop>
          <span class="figure__value">Free</span>
          <span class="figure__label">For IISER Kolkata students</span>
          <span class="figure__note">External participants · registration ₹200, hostel ₹200/day optional</span>
        </div>
      </div>
  ...
  <section class="section" id="schedule">
    <div class="container">
      ...
      <div class="section__head">
        <h2 data-drop>Four days, start to finish.</h2>
        <p class="lede" data-drop>
          Days 0–2 meet at <strong>MN Saha</strong>: kick-off and installation, the primer and Labs 1–2,
          then advanced topics. Day 3 closes with the expert talk and panel in <strong>G06</strong>.
          The invited speaker and panellists will be announced closer to the date.
        </p>
      </div>
  ...
  <section class="section section--tight">
    <div class="container">
      <div class="mystery" data-drop>
        ...
        <div>
          <p class="eyebrow">Day 3 · Invited talk</p>
          <h3 style="margin-top:1rem">The IBM Industry Insider is still in superposition.</h3>
          <p class="muted">
            We close the fest on <strong>13 October, 6–8 PM in G06</strong> with an invited expert from
            the IBM&nbsp;Quantum ecosystem — someone who builds and ships this technology for a living —
            followed by a panel with the IBM guest and faculty. The names are sealed until the
            announcement. Register now and you are measured into it first, by email.
          </p>
    ...
    <div class="container">
      ...
      <div data-drop-group="70">
        ...
        <a class="res-item" data-drop href="resources.html#notebooks">
          ...
          <span><h3>Lab notebooks</h3><p>Day 1 Labs 1–2 and the Day 2 advanced challenge notebook, published before each session and kept in the repository afterwards.</p></span>
        </a>
        <a class="res-item" data-drop href="resources.html#reading">
          <span class="res-item__badge">03</span>
          <span><h3>Pre-reading</h3><p>A short, honest reading list. None of it is compulsory; all of it makes Day 1 easier.</p></span>
        </a>
  ...
  <section class="section section--alt" id="venue">
    <div class="container">
      ...
      <div class="venue">
        ...
        <div data-drop>
          <h2 style="margin-bottom:1.25rem">MN Saha &amp; G06, IISER Kolkata</h2>
          <p class="muted">
            Sessions run in the MN Saha lecture hall on the Mohanpur campus, and the closing day's talk
            and panel are in G06. Bring a laptop and a charger; power and Wi-Fi are available in the hall.
          </p>
          <ul class="venue__list">
            <li><b>Address</b><span>Mohanpur Campus, Mohanpur, Nadia, West Bengal 741246</span></li>
            <li><b>Timing</b><span>Kick-off on Day 0 evening; Day 1 runs 10 AM – 5 PM; Day 2 sessions are late evening; the finale is 6 – 8 PM on Day 3</span></li>
            <li><b>Fee</b><span>Free for IISER Kolkata students. External participants pay a ₹200 registration fee; optional hostel accommodation is ₹200 per day, requested on the form.</span></li>
  ...
  <section class="section" id="team">
    <div class="container">
      ...
      <p class="muted" style="margin-top:2.5rem;font-size:var(--step--1)">
        ...
        <a href="#speakers">just below</a>, and the invited closing speaker will be announced closer to the date.
      </p>
    </div>
  </section>
  ...
  <section class="section section--alt" id="speakers">
    <div class="container">
      <p class="section__index" data-drop="line"><b>08</b> <span>Who is teaching</span> <span>Talks and labs</span></p>
      <div class="section__head">
        <h2 data-drop>And who is teaching it.</h2>
        <p class="lede" data-drop>
          Every session is taught by someone who will still be in the room afterwards. The Day 1 morning
          primer is run with <strong>Gluon</strong>, the physics society; the rest is SlashDot. The
          closing expert talk is followed by a panel with the IBM guest and faculty; their names are still to be announced.
        </p>
      </div>
      <div class="people" data-speakers data-drop-group="80"></div>
      <p class="muted" style="margin-top:2.5rem;font-size:var(--step--1)">
        Sessions and times are on <a href="#schedule">the schedule</a>. The Day 3 invited speaker and
        panellists are still being finalised.
      </p>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="cta-band" data-drop>
        ...
        <p>
          Registering takes about ninety seconds. Participation is free for IISER Kolkata students;
          external participants pay a ₹200 registration fee, with optional hostel accommodation at
          ₹200 per day. Registering is how you get the notebooks, the announcements and &mdash;
          eventually &mdash; your certificate.
        </p>
