...
**6 – 13 October 2026 · MN Saha, IISER Kolkata · Free and open to all students**
...
│   ├── components.css      Nav, buttons, cards, marquee, accordion, background field
│   ├── sections.css        Hero, schedule, lab, tiers, people, venue, footer
...
│   ├── quantum-field.js    Ambient canvas — qubits, entanglement links, circuit rails
...
│   ├── build_pages.py      Generates the pages marked (generated) above
...
npm run build:pages    # regenerate resources / gallery / archive / 404 / sitemap
```
